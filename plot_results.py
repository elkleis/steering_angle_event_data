"""
Creates plot for real and predicted steering angle values through time.
"""
...
def _main():
    ...
    fname_steer = os.path.join(FLAGS.experiment_rootdir, 'evaluation_results', 'predicted_and_real_steerings.json')
    with open(fname_steer, 'r') as f:
        results_dict = json.load(f)
    make_and_save_histograms(results_dict['pred_steerings'], results_dict['real_steerings'],
                             os.path.join(FLAGS.experiment_rootdir, "plots", "histograms.png"))
