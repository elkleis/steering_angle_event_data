...
def _main():
    ...
    test_generator = test_datagen.flow_from_directory(FLAGS.video_dir,
                                                      shuffle=False,
    ...
    utils.write_to_file(steer_dict, os.path.join(FLAGS.video_dir, FLAGS.video,
