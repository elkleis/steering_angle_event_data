...
def raster_evts(data):
    ...
    # First channel of a DVS frame contains the positive events, and the second one contains the negative events.
...
if __name__ == '__main__':
    ...
    # DDD17
    parser.add_argument('--source_folder', default='/mnt/Seagate/DDD17/ddd17/test',
                        help='Path to HDF5 files.')
    parser.add_argument('--dest_folder', default='/mnt/Seagate/DDD17/ddd17/result',
                        help='Path to where saving the new HDF5 files.')
    # DDD20
    # parser.add_argument('--source_folder', default='/mnt/Seagate/DDD17/ddd20/dataset/jul29',
    #                     help='Path to HDF5 files.')
    # parser.add_argument('--dest_folder', default='/mnt/Seagate/DDD17/ddd20/model/data',
    #                     help='Path to where saving the new HDF5 files.')
    ...
    parser.add_argument('--binsize', type=float, default=0.05,
                        help='If positive, events will be binned into time-slices of BINSIZE seconds. If negative, '
                             'frames will be generated every abs(BINSIZE) events.')
    ...
    for rec in recordings:
        print("Unpacking frames for '{}'\n".format(rec))
        # If the file already exists, delete it
        fname = os.path.join(args.dest_folder, os.path.split(rec)[1])
            ...
            if d['etype'] == 'polarity_event' and args.export_dvs:
                ...
                if fixed_dt:
                    ...
                    for _ in xrange(int(num_samples)):
                        ...
                        offset += n
                        # save if we're in the middle of a packet, otherwise wait for more data
        ...
        print('Finished.  Wrote {:.1f}MiB to dir {}.\n'.format(filesize / 1024 ** 2, outfile))
