...
import logz
from fusion_resnet34 import intermediate_fusion_resnet34, fusion_identity_resnet34
...
def get_model(img_width, img_height, img_channels, output_dim, weights_path):
    ...
    """
    # model = intermediate_fusion_resnet34(img_width, img_height, img_channels, output_dim)
    model = fusion_identity_resnet34(img_width, img_height, img_channels, output_dim)
...
def train_model(train_generator, validation_generator, model, initial_epoch, weights_dir):
    ...
    validation_steps = int(np.ceil(val_samples / FLAGS.batch_size)) - 1
...
def _main():
    ...
    # Define model
    model = get_model(FLAGS.img_width, FLAGS.img_height, img_channel, output_dim, weights_path)
